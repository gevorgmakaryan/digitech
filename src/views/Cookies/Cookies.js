...
const Cookies = () => {
  return (
    <Container>
      <Box marginBottom={4}>
        <Typography variant="h3" gutterBottom sx={{ fontWeight: 700 }}>Cookie policy</Typography>
        <Typography variant="subtitle1"><i>Updated March 20, 2020</i></Typography>
      </Box>
      <Box marginBottom={4}>
        <Typography variant="h4" gutterBottom sx={{ fontWeight: 700 }}>1. What are cookies?</Typography>
      ...
      <Box marginBottom={4}>
        ...
        <Typography variant="h6" gutterBottom sx={{ fontWeight: 700 }}>2.1. Which cookies are used by Digitexpo?</Typography>
        <Typography gutterBottom>
        ...
        <br />
        <Typography variant="h6" gutterBottom sx={{ fontWeight: 700 }}>2.2 What data is stored in the cookies?</Typography>
        <Typography>
        ...
        <Typography>
        Digitexpo makes use of a number of web partners, for example, Google Analytics, Facebook and Doubleclick who help to make our websites more interesting for you. This is why, when visiting our websites, the cookies of these companies may also be stored on your hard disk. These cookies are deleted automatically after a pre-specified period. The cookies of our partner companies also contain solely pseudonymous or anonymous aggregated data. This relates, for example, to data on which pages you have looked at, whether anything was bought or a signup occurred, among other actions. Here, some of our advertising partners also collect information from our websites on which pages you have previously visited in order to be able to show you advertising that best complies with your interests.
        </Typography>
        <br />
      ...
      <Box marginBottom={4}>
        ...
        <br />
        <Typography variant="h6" gutterBottom sx={{ fontWeight: 700 }}>4.1 Google Analytics</Typography>
        <Typography>
